...
<body>
	...
	<section>
		<h2>About Me</h2>
		<ul>
			<li><strong>Name:</strong> [barath]</li>
			<li><strong>Class:</strong> [B.Sc.Computer science]</li>
			<li><strong>Age:</strong> [18]</li>
			<li><strong>Number:</strong> [6381273300]</li>
			<li><strong>Gmail:</strong> <a href="mailto:[barathcsa@gmail.com]">[barathcsa@gmail.com]</a></li>
		</ul>
	</section>
